	...
	.controller('gitHubDataController', ['$scope','$http', function($scope, $http) {
		$scope.functionalities = [
			{"id": 0, "name": "Home", "glyphicon": "glyphicon glyphicon-home glyph-white"},
			{"id": 1, "name": "Repositories", "glyphicon": "glyphicon glyphicon-folder-open glyph-white"},
			{"id": 2, "name": "Contributions", "glyphicon": "glyphicon glyphicon-education glyph-white"},
			{"id": 3, "name": "Trending", "glyphicon": "glyphicon glyphicon-eye-open glyph-white"},
			{"id": 4, "name": "Pinned", "glyphicon": "glyphicon glyphicon-pushpin glyph-white"}
		];
